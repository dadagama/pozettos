		...
		$html->tag("tr");
			$html->tag("td");
				$html->tag("table", array("id"=>"tbl_servicios"));
					$html->tag("tr");
						$html->tag("td");
							$html->printSelect($conexion_bd_bozettos, "dus_minutos", "dus_texto", "pozettos_duracion_servicio", "", "00:00:00", array("id"=>"ves_duracion", "class"=>"ancho_80 verdana letra_9 alineacion_centro letra_roja negrilla"));
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Xbox 1"));
								$html->tag("img", array("src"=>"../imagenes/x1.png"), true);
							$html->end("button");
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Xbox 2"));
								$html->tag("img", array("src"=>"../imagenes/x2.png"), true);
							$html->end("button");
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Play 1"));
								$html->tag("img", array("src"=>"../imagenes/p1.png"), true);
							$html->end("button");
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Play 2"));
								$html->tag("img", array("src"=>"../imagenes/p2.png"), true);
							$html->end("button");
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Cabina 1"));
								$html->tag("img", array("src"=>"../imagenes/pc1.png"), true);
							$html->end("button");
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Cabina 2"));
								$html->tag("img", array("src"=>"../imagenes/pc2.png"), true);
							$html->end("button");
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Cabina 3"));
								$html->tag("img", array("src"=>"../imagenes/pc3.png"), true);
							$html->end("button");
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Cabina 4"));
								$html->tag("img", array("src"=>"../imagenes/pc4.png"), true);
							$html->end("button");
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Wii 1"));
					...
					$html->tag("tr");
						...
						$html->end("td");
						$html->tag("td");
							$html->tag("button", array("onclick"=>"", "title"=>"Recarga"));
		...
		// $html->tag("tr");
			// $html->tag("td", array("colspan"=>"2"));
				...
				//ENCABEZADOS HISTORIAL		
					...
					$html->tag("tbody", array("id"=>"ves_historial", "class"=>"cuerpo_historial"));
